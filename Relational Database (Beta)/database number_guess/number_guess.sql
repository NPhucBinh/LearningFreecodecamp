...
INSERT INTO public.number_guess VALUES (86, 'BINH', 4, 1);
INSERT INTO public.number_guess VALUES (88, 'USER_1681108403268', 16, NULL);
INSERT INTO public.number_guess VALUES (87, 'USER_1681108403269', 32, NULL);
...
SELECT pg_catalog.setval('public.number_guess_user_id_seq', 88, true);


--
-- Name: number_guess username_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.number_guess
    ADD CONSTRAINT username_unique UNIQUE (usernames);
